...
class MakeReport extends UseCase<String,MultiParams<String, ReportModel,String>>{
  final ReportRepo repo;

  MakeReport(this.repo);
  @override
  Future<Either<Failure, String>> call(MultiParams<String, ReportModel, String> params) async {
